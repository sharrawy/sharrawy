...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/IE7IE'}, },}}
...
if text == 'رفع نسخة ' and msg.reply_to_message_id ~= 0 then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⌔︙هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم استرجاع المجموعات ')
else
...
if not Redis:get(TheWaTaN.."knele"..msg.chat_id) then
Abs = math.random(4,2824); 
local Text ='*✯︙تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text = '✯ NIGHTMARE source .',url="t.me/IE7IE"}}} 
local msg_id = msg.id/2097152/0.5 
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/IlElIl/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
end
...
keyboard.inline_keyboard = {{{text = '✯ NIGHTMARE source .',url="t.me/IE7IE"}}} 
local msg_id = msg.id/2097152/0.5 
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/TTUT2/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
end
...
keyboard.inline_keyboard = {{{text = '✯ NIGHTMARE source .',url="t.me/IE7IE"}}} 
local msg_id = msg.id/2097152/0.5 
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/TTUT21/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
end
...
if (Redis:get(KOIA.."KOIA:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(KOIA.."KOIA:AddSudosNew"..msg_chat_id)
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء امر تغيير المطور الاساسي","md",true)    
end 
Redis:del(KOIA.."KOIA:AddSudosNew"..msg_chat_id)
if text and text:match("^@[%a%d_]+$") then
...
Redis:set(KOIA.."KOIA:AddSudosNew"..msg_chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙ارسل معرف المطور الاساسي مع @","md",true)
end
...
if text == "ميمز" or text == "memes" then
if not Redis:get(TheWaTaN.."knele"..msg.chat_id) then
Abs = math.random(4,2824); 
local Text ='*✯ تم اختيار صوتيه مميز لك 🦦😉*'
keyboard = {}  
keyboard.inline_keyboard = {{{text = '✯ NIGHTMARE source.',url="t.me/IE7IE"}}} 
local msg_id = msg.id/2097152/0.5 
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/IlmIlmIlmIl/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
end
...
data = {
{
{text = 'Channel Source ،', url = 't.me/IE7IE'}, 
},
{
{text = 'Annotations Source', url = 't.me/IE8IE8'}, 
},
{
{text = 'Communication Source', url = 't.me/mohmrgbot'}, 
},
{
{text = 'Developer Source !', url = 't.me/IEBIE'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
if text == (Redis:get(Revor.."Revor:Name:Bot") or "NIGHTMARE") then
local NamesBot = (Redis:get(Revor.."Revor:Name:Bot") or "NIGHTMARE")
local NameBots = {
"عمر "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n⌔︙أهلآ بك في بوت '..(Redis:get(Revor.."Revor:Name:Bot") or "NIGHTMARE")..
