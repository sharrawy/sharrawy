...
return {
Lock     = '[- Source Telethon .](https://t.me/iqthon)\n*— — — — — — — — —\n᯽︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᯽︙خاصيه المسح *',
unLock   = '[- Source Telethon .](https://t.me/iqthon)\n*— — — — — — — — —\n᯽︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[- Source Telethon .](https://t.me/iqthon)\n*— — — — — — — — —\n᯽︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᯽︙خاصيه الكتم *',
lockKid  = '[- Source Telethon .](https://t.me/iqthon)\n*— — — — — — — — —\n᯽︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᯽︙خاصيه التقييد *',
lockKick = '[- Source Telethon .](https://t.me/iqthon)\n*— — — — — — — — —\n᯽︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᯽︙خاصيه الطرد *',
Reply    = '[- Source Telethon .](https://t.me/iqthon)\n*— — — — — — — — —\n᯽︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
elseif tonumber(msg.sender.user_id) == 111111 then
...
{
{text = '『 Source Telethon』', url = 't.me/iqthon'},
},
}
}
if not msg.ControllerBot then
...
if Redis:get(TheKOIA.."Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if text == "صورتي" then
if Redis:get(TheKOIA.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
if photo.total_count > 0 then
...
{
{text = '.َ ‹ Source Telethon ⁦⁦.𖨬', url = "https://t.me/iqthon"}
},
}
...
{
{text = '᯽ Developer', url = "https://t.me/lll5l"}
},
{
{text = ' ᯽ Source Channel', url = "https://t.me/iqthon"}
},
}
local msgg = msg_id/2097152/0.5
...
data = {
{
{text = '᯽ السورس .', url = 't.me/iqthon'},{text = '᯽ لتنصيب بوت .', url = 't.me/lll5l'}, 
},
{
